            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.badge("+" + p.pts.to_string() + " pts",
                             color_scheme="green", variant="soft", font_weight="700"),
                    align="center", width="100%",
                ),
...
def dashboard_page() -> rx.Component:
    return rx.box(
        ...
        rx.box(
            ...
            rx.tabs.root(
                rx.tabs.list(
                    rx.tabs.trigger(rx.hstack(rx.icon("home",    size=14), rx.text("Inicio"),      gap="0.3rem", align="center"), value="home"),
                    rx.tabs.trigger(rx.hstack(rx.icon("truck",   size=14), rx.text("Rutas"),       gap="0.3rem", align="center"), value="routes"),
                    rx.tabs.trigger(rx.hstack(rx.icon("map-pin", size=14), rx.text("Acopio"),      gap="0.3rem", align="center"), value="points"),
                    rx.tabs.trigger(rx.hstack(rx.icon("clock",   size=14), rx.text("Historial"),   gap="0.3rem", align="center"), value="history"),
                    rx.tabs.trigger(rx.hstack(rx.icon("gift",    size=14), rx.text("Recompensas"), gap="0.3rem", align="center"), value="rewards"),
                    rx.tabs.trigger(rx.hstack(rx.icon("trophy",  size=14), rx.text("Ranking"),     gap="0.3rem", align="center"), value="ranking"),
